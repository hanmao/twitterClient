...
public class TimeLineActivity extends AppCompatActivity {
    private ArrayList<TweetModel> twttrList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        twttrList = new ArrayList<TweetModel>();
        adapter = new TwitterListAdapter(this, twttrList);
    ...
    public void onComposeTweet(MenuItem mi)
    {
        ...
        TwitterComposeDialog composeTweetDialog = TwitterComposeDialog.newInstance("Compose Tweet");
